module.exports = {
    ...
    theme: {
        ...
        fontFamily: {
            ...
            serif: [
                "Palatino Linotype, Palatino, Book Antiqua, Baskerville, Bookman Old Style, Garamond, Apple Garamond, Century Schoolbook, Georgia, serif",
                "ui-serif",
                "Georgia",
                "Cambria",
                '"Times New Roman"',
        ...
        fontSize: {
            xs: ["0.6875rem", {lineHeight: "1rem"}], // Adjusted proportionally from base
            sm: ["0.8125rem", {lineHeight: "1.25rem"}],
            sm: ["0.8125rem", {lineHeight: "1.25rem"}],
            base: ["1.0625rem", {lineHeight: "1.25rem"}], // 17px base size
